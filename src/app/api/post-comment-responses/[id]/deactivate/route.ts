...
export async function POST(
    ...
    const isPostOwner = resp.post_comment.post.authorId === sessionUserId;
    const isCommentOwner = resp.post_comment.who_comments === sessionUserId;
    const isResponseOwner = resp.who_responses === sessionUserId;

    // Dueño del post OR dueño del comentario OR dueño de la respuesta.
