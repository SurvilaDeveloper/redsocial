      ...
      "
        >
            ...
            <div className="flex items-center gap-3 lg:gap-4">
                ...
                <Link
                    href="/"
                    className="px-1 lg:px-2 flex items-center"
                    title={cfg.TEXTS.inicio}
                    onClick={handleHomeClick}
                >
                    <House className="w-5 h-5 lg:w-6 lg:h-6 text-gray-400 hover:text-gray-100" />
                </Link>
                ...
                {session && (
                    <>
                        ...
                        >
                            <Plus className="w-5 h-5 lg:w-6 lg:h-6 text-gray-400 hover:text-gray-100" />
                        </Link>
                        ...
                        >
                            <BrickWall className="w-5 h-5 lg:w-6 lg:h-6 text-gray-400 hover:text-gray-100" />
                        </Link>
                    </>
                )}
                ...
                >
                    <Search className="w-5 h-5 lg:w-6 lg:h-6 text-gray-400 hover:text-gray-100" />
                </Link>
            </div>
