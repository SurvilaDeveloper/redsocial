...
export function OwnerToolbar({
    ...
    // RESTAURADO / OCULTO
    // Importante: este bloque debe ir ANTES que el bloque normal.
    // Antes quedaba inalcanzable porque `isOwner && !isDeleted`
    // capturaba también los posts con active=0.
        ...
        return (
            <div className="mb-2 flex flex-row flex-wrap items-center gap-2 w-full text-red-200 bg-[rgb(64,20,20)] px-3 py-2 rounded-md border border-red-700/40">
                ...
                <button
                    ...
                    className="flex flex-row items-center h-7 gap-1 text-[11px] px-2 rounded bg-green-800 border border-green-700 hover:bg-green-700 disabled:opacity-50"
                >
                    <EyeIcon size={12} />
                    <span>Activar publicación</span>
                </button>

                <Link
                    href={`/editpost?post_id=${postId}`}
                    title="Editar"
                    className="flex flex-row items-center h-7 gap-1 text-[11px] px-2 rounded bg-slate-800 border border-slate-600 hover:bg-slate-700"
                >
                    <Pencil size={12} />
                </Link>
                ...
                <button
                    ...
                    disabled={ownerActionsLoading}
                    title="Enviar nuevamente a la papelera de reciclaje"
                    className="flex flex-row items-center h-7 gap-1 text-[11px] px-2 rounded bg-slate-800 border border-slate-600 hover:bg-red-700 disabled:opacity-50"
                >
                    <Trash2 size={12} />
                </button>
        ...
        return (
            <div className="mb-2 flex flex-row items-center gap-2 w-full min-h-8 text-white bg-black px-3 py-2 rounded-md">
                ...
                <button
                    ...
                    disabled={ownerActionsLoading}
                    title="Ocultar"
                    className="flex flex-row items-center h-6 gap-1 text-[11px] px-2 rounded bg-slate-800 border border-slate-600 hover:bg-red-800 disabled:opacity-50"
                >
                    <EyeOffIcon size={12} />
                </button>
